...
$ cd container-debug-artifacts/runc/v1.2.0-rc.2/
$ ./image.sh
$ cd runc
$ make shell
...
or use my pre-built image ssst0n3/runc_dev:v1.2.0-rc.2
...
$ ./apply-patch.sh
$ cd runc
$ docker pull ssst0n3/runc_dev:v1.2.0-rc.2
$ make shell RUNC_IMAGE=ssst0n3/runc_dev:v1.2.0-rc.2
