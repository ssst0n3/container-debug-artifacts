...
$ cd container-debug-artifacts/runc/v1.1.11/
$ ./image.sh
$ cd runc
$ make shell
...
or use my pre-built image ssst0n3/runc_dev:v1.1.11
...
$ ./apply-patch.sh
$ cd runc
$ docker pull ssst0n3/runc_dev:v1.1.11
$ make RUNC_IMAGE=ssst0n3/runc_dev:v1.1.11 shell
