...
$ cd container-debug-artifacts/runc/v1.3.0/
$ ./image.sh
$ cd runc
$ make shell
...
or use my pre-built image ssst0n3/runc_dev:v1.3.0
...
$ ./apply-patch.sh
$ cd runc
$ docker pull ssst0n3/runc_dev:v1.3.0
$ make shell RUNC_IMAGE=ssst0n3/runc_dev:v1.3.0
